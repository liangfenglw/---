...
<head>
	...
	<title>活动列表( 派单类 ) - 个人及代理商 - 亚媒社</title>
...
<div class="main" style="margin-top:40px;">
	...
	<div class="hdorder radius1">
		<h3 class="title1"><strong><a href="#">活动列表</a></strong>
			<div class="search_1">
		...
		<div class="dhorder_m">
			<div class="tab1">
				<ul>       
					<li class="cur"><a href="huodonglist_paidan.php">派单类</a></li>
					<li><a href="huodonglist_yuyue.php">预约类</a></li>
				</ul>
			</div>
			<div class="tab1_body">
...
<thead>
	<tr>
		...
		<th><select >
				...
				<option value="">活动状态1</option>
				<option value="">活动状态2</option>
				<option value="">活动状态3</option>
			</select></th>
		<th>操作</th>
	</tr>
</thead>
